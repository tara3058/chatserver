...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.response_),
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "esponse\022$\n\010response\030\001 \001(\0132\022.fixbug.Resul"
...
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& response(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_response()) {
    _this->_impl_.response_ = new ::fixbug::ResultCode(*from._impl_.response_);
  }
...
void LoginResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_response()) {
    _this->_internal_mutable_response()->::fixbug::ResultCode::MergeFrom(
